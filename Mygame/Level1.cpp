...
bool Level1::initializeGame(HWND hwnd)
{
	...
	player = new Player(50.0f, 50.0f, (float)M_PI_4, 1.0f, 20.0f); //x ,y ,rotation,speed,maxspeed
	player2 = new Player(200.0f, 200.0f, 0, 0, 0);//x ,y ,rotation,speed,maxspeed
	...
	player2->setState(2); //<----- state set to 2 because state controls the colour
	return true;
}
